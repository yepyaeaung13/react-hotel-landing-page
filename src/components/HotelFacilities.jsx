        ...
        <div className="text-nowrap grid md:grid-cols-4 grid-cols-2 gap-20">
          <div className="flex flex-col items-center">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-12 p-2 bg-purple-700 text-white rounded-md"
            >
              <path
                strokeLinecap="round"
            ...
            <SubHeading>Free Parking</SubHeading>
          </div>
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <SubHeading>Free Wifi</SubHeading>
          </div>
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <SubHeading>Pet Friendly</SubHeading>
          </div>
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-col items-center">
            ...
            <SubHeading>24-Hours Front Desk</SubHeading>
          </div>
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <SubHeading>Shuttle Bus Service</SubHeading>
          </div>
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <SubHeading>Bicycle Rental</SubHeading>
          </div>
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <SubHeading>Downtown Location</SubHeading>
          </div>
        </div>
      </div>
    </Container>
